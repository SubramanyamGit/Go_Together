  ...
  return (
    <div className="vh-100 d-flex">
      <div className="col-md-6 d-none d-md-block">
         ...
         <img
    src="https://res.cloudinary.com/dvduw2l98/image/upload/c_thumb,w_200,g_face/v1743297553/bg_nhcbxf.png"
    alt="Go Together"
    className="img-fluid"
      ...
      <div className="col-md-6 d-flex align-items-center justify-content-center">
        <div className="card shadow-lg p-4 w-75">
          ...
          <p className="text-center mt-3">
            Already have an account? <Link to="/signin"  className="text
            -success"
            >Sign In</Link>
          </p>
        </div>
